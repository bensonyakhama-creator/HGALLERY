...
export const Route = reactRouter.createRootRouteWithContext<{
  ...
  head: () => ({
    meta: [
      ...
      { title: "H.Gallery — Glass, Framing, Panels, Decor & Tools in Nairobi" },
      {
        name: "description",
        content:
          "H.Gallery Ltd — glass & aluminium, custom picture framing, wall panels, home decor, DIY power & hand tools and camping gear on Magadi Road, Nairobi.",
      },
