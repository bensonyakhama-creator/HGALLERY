...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "H.Gallery Ltd — glass & aluminium, custom picture framing, wall panels, home decor, DIY power & hand tools and camping gear on Magadi Road, Nairobi." },
      { name: "author", content: "H.Gallery Ltd" },
      { property: "og:title", content: "H.Gallery — Glass, Framing, Panels, Decor & Tools" },
      { property: "og:description", content: "Your one-stop showroom on Magadi Road, Nairobi." },
