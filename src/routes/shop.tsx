  ...
  head: () => ({
    meta: [
      { title: "Shop — H.Gallery" },
      {
        name: "description",
        content:
          "Browse glass & aluminium, framing, wall panels, decor, tools and camping gear at H.Gallery, Nairobi.",
      },
      ...
      <section className="border-b border-border bg-gradient-hero py-16 text-brand-foreground">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-2xl text-white/80">
            Explore our full range — from architectural glass to weekend camping
            essentials.
          </p>
        </div>
      </section>
